import{h as n,r as e,a as c}from"./config-2b8a8b87.js";const s=localStorage.getItem("token")!==null,u=localStorage.getItem("role")==="admin";localStorage.getItem("userId");const o=document.querySelector("#navBar"),l=document.querySelector("#placeName"),i=document.querySelector("#placeDetail"),r=location.href.split("=")[1],m=document.querySelector("#saveChanges"),d=document.querySelector("#cancelEditing");function g(){axios.get(c+"/views/"+r).then(function(t){console.log(t.data);const a=t.data;l.value=a.name,i.textContent=a.description})}g();d.addEventListener("click",function(){window.location.href=`${n}${e}/backboard.html`});function h(){axios.patch(`${c}/views/${r}`,{name:l.value,description:i.value}).then(function(t){console.log(t.response),alert("修改成功"),window.location.href=`${n}${e}/backboard.html`}).catch(function(t){console.log("修改景點時出錯了："),console.log(t.response)})}m.addEventListener("click",function(){h()});function f(){s?(u?o.innerHTML=` 
