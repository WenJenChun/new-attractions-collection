import{h as n,r as e,a as c}from"./config-2b8a8b87.js";const s=localStorage.getItem("token")!==null,u=localStorage.getItem("role")==="admin";localStorage.getItem("userId");const o=document.querySelector("#navBar"),l=document.querySelector("#placeName"),i=document.querySelector("#placeDetail"),r=location.href.split("=")[1],d=document.querySelector("#saveChanges"),m=document.querySelector("#cancelEditing");function h(){axios.get(c+"/views/"+r).then(function(t){console.log(t.data);const a=t.data;l.value=a.name,i.textContent=a.description})}h();m.addEventListener("click",function(){window.location.href=`${n}${e}/backboard.html`});function g(){axios.patch(`${c}/views/${r}`,{name:l.value,description:i.value},{}).then(function(t){console.log(t.response)}).catch(function(t){console.log(t.response)})}d.addEventListener("click",function(){g(),location.reload(),window.location.href=`${n}${e}/backboard.html`});function f(){s?(u?o.innerHTML=` 
